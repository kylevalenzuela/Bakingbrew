 ...
 */
function baking_brew_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar', 'baking-brew' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
add_action( 'widgets_init', 'baking_brew_widgets_init' );
...
function baking_brew_scripts() {
	...
	wp_enqueue_script( 'baking-brew-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );
