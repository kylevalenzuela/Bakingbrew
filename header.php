	...
	<header id="masthead" class="site-header" role="banner">
		<div class="logo">
				<div class="logo-icon">
					...
					<?php include("icons/bakingbrewlogo.svg"); ?>
					</a>
				</div>
		</div>
				...
				<?php wp_nav_menu(array(
					...
					'link_before'    => '
						<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
							  viewBox="0 0 98.004 100" height="65" enable-background="new 0 0 98.004 100" class="wheatstock" xml:space="preserve">
